...
public class RelizcNeoCrossbow extends RelizcItemStack {

	public RelizcNeoCrossbow(Player owner, ItemStack it) {
		super(owner, it);
	...
	public List<String> renderInternalLore() {
	    ...
	    return StringUtils.fromArgs(loc.a("item.crossbow." + this.getID().toLowerCase() + ".description"), " ", 
